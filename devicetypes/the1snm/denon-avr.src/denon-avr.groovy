...
metadata {
    definition (name: "Denon AVR", namespace: "the1snm", 
	...
	tiles(scale: 2) {
        ...
        standardTile("CBL", "device.switch", width: 2, height: 2, decoration: "flat"){
            state "Cable ON", label: 'U-Verse', action: "cbl", icon:"st.Electronics.electronics3" , backgroundColor: "#53a7c0"         
...
//            }
        standardTile("BD", "device.switch", width: 2, height: 2, decoration: "flat"){
        	state "BD", label: 'Playstation', action: "BD", icon:"st.Electronics.electronics8"
        	}
...
//        	}
		standardTile("MP", "device.switch", width: 2, height: 2, decoration: "flat"){
        	state "Media Player", label: 'Apple TV', action: "MP", backgroundColor: "#ffffff", icon:"st.Electronics.electronics9"
			}
